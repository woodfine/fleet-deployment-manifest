...
1. **The Payload Split:** Incoming corporate documents are stripped of execution privileges and placed in `/assets/`. A cryptographic YAML pointer is generated in `/ledger/`.
...
3. **Template Injection:** The engine retrieves the domain-specific layout from `/service-study/templates/` and injects the synthesized data.
